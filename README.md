...
├── SQL/
│   └── day1_day2_analysis.sql # Full SQL pipeline: setup, cleaning, EDA
├── Reports/
│   ├── Business_Insights.docx # 10 business insights with evidence & recommendations
...
Full SQL pipeline: [`SQL/day1_day2_analysis.sql`](./SQL/day1_day2_analysis.sql)
...
- [ ] Risk segmentation using SQL `CASE` logic (Low/Medium/High risk buckets)
- [ ] Window functions for ranking and cumulative risk analysis
